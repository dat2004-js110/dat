// Ex 1: Learn how to create a random number from 0 to 1
// {
//     console.log(`First run: ${Math.random().toFixed(2)}`);
//     console.log(`Second run: ${Math.random().toFixed(2)}`);
// }
// // Ex 2: Learn how to randomly pick an item from an array
// {
...
// }
// Ex 3: Create a data structure to represent a list of quizzes, each quiz contains a question, 4 choices and rightChoice. Create it then ask your mentor to review your data before moving to the next exercise
/*{
    let listQuestion = [
        {
...
// Ex 1.6:Let it run continuously, make sure each question only appears once, if the questions has run out, let users know (note that the result showing to users are omitted in the figure below)
// tham khao bai Huu Dung
    let questionAnswer = {};
...
// tham khảo bài 2.2 --> 2.7 của b Hữu Dũng
const inventory = [
    {
        name: 'HP Envy 13aq',
        price: 21000,
